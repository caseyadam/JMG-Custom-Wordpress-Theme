...
axios.get('wp-json/wp/v2/testimonials')
  .then(function(response) {
    ...
    var featuredImgId = []
    //loop/map over all posts, get ID of each "(item)", push ID into array
...
var initApp = function(data){
  ...
  // "This" is referring to the array itself
  // This is a method to swap different indexes of the array
