      ...
      <div class="container">
        ...
        <div class="services-container">
          <?php 
            ...
            $mypod->find('name ASC');
          ?>
          <!-- THIS LOOPS OVER EVERY SERVICE YOU CREATE -->
            ...
            <?php
              ...
              if(!function_exists('get_post_featured_image')) {
                  function get_post_featured_image($post_id, $size) {
                      ...
                      $image_url = $image[0];
                      $image_alt = get_post_meta($image_id, 'wp_attachment_image_alt', true);
      ...
      <div class="container">
        ...
        <div class="blog-container">
          <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            <!-- start of post -->
            <a href="blog/<?php the_permalink(); ?>" class="post post-<?php the_ID(); ?>">
